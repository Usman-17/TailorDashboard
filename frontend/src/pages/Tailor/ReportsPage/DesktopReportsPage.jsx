  ...
  return (
    <>
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-2 gap-3 px-1 py-2 border-b border-gray-200 dark:border-gray-800">
        <SectionHeading
          title="Reports"
          subtitle={`Business analytics — ${periodLabel || "This Month"}`}
        />
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-2">
              <div className="w-full sm:w-40">
                <CustomDatePicker
                  ...
                  onChange={(d) =>
                    setCustomFrom(d ? d.format("YYYY-MM-DD") : "")
                  }
                  placeholder="From"
                  allowClear
                />
      ...
      <div className="grid grid-cols-1 min-[420px]:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 my-4 sm:my-5">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl p-5 border border-gray-200 dark:border-gray-800 shadow-sm">
          ...
          <p className="text-xl sm:text-2xl font-bold text-amber-600 dark:text-amber-400 truncate">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl p-5 border border-gray-200 dark:border-gray-800 shadow-sm">
          ...
          <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
            {summary?.totalExpenseCount || 0} recorded
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl p-5 border border-gray-200 dark:border-gray-800 shadow-sm">
          <div className="flex items-center justify-between mb-3">
            <div
              className={`p-2 rounded-lg ${(summary?.netCashProfit || 0) >= 0 ? "bg-blue-100 dark:bg-blue-900/30" : "bg-red-100 dark:bg-red-900/30"}`}
            >
            ...
            <span
              className={`text-xs font-medium ${(summary?.netCashProfit || 0) >= 0 ? "text-blue-600 dark:text-blue-400" : "text-red-600 dark:text-red-400"}`}
            >
              Net Cash Profit
            </span>
          </div>
          <p
            className={`text-xl sm:text-2xl font-bold truncate ${(summary?.netCashProfit || 0) >= 0 ? "text-gray-900 dark:text-white" : "text-red-600 dark:text-red-400"}`}
          >
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl p-5 border border-gray-200 dark:border-gray-800 shadow-sm">
          <div className="flex items-center justify-between mb-3">
            <div
              className={`p-2 rounded-lg ${(summary?.cashProfitMargin || 0) >= 0 ? "bg-emerald-100 dark:bg-emerald-900/30" : "bg-red-100 dark:bg-red-900/30"}`}
            >
              <Activity
                className={`w-5 h-5 ${(summary?.cashProfitMargin || 0) >= 0 ? "text-emerald-600 dark:text-emerald-400" : "text-red-600 dark:text-red-400"}`}
              />
            </div>
            <span
              className={`text-xs font-medium ${(summary?.cashProfitMargin || 0) >= 0 ? "text-emerald-600 dark:text-emerald-400" : "text-red-600 dark:text-red-400"}`}
            >
              Cash Profit Margin
            </span>
          </div>
          <p
            className={`text-xl sm:text-2xl font-bold truncate ${(summary?.cashProfitMargin || 0) >= 0 ? "text-gray-900 dark:text-white" : "text-red-600 dark:text-red-400"}`}
          >
            {summary?.cashProfitMargin || 0}%
          </p>
          <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
            (Profit ÷ Payments Received) × 100
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 my-5">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl p-5 border border-gray-200 dark:border-gray-800 shadow-sm">
          <h3 className="text-sm font-semibold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
            <BarChart3 size={16} className="text-purple-500" /> Collection vs
            Expenses
          </h3>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl p-5 border border-gray-200 dark:border-gray-800 shadow-sm">
          <h3 className="text-sm font-semibold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
            <PieChart size={16} className="text-purple-500" /> Orders & Delivery
            Performance
          </h3>
          <div className="space-y-3">
            ...
            <div className="mt-4 pt-4 border-t border-gray-100 dark:border-gray-800">
              ...
              <div className="grid grid-cols-3 gap-2">
                ...
                <div className="text-center p-2 rounded-lg bg-amber-50 dark:bg-amber-900/20">
                  <Clock
                    size={16}
                    className="mx-auto text-amber-600 dark:text-amber-400 mb-1"
                  />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 my-5">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl p-5 border border-gray-200 dark:border-gray-800 shadow-sm">
          <h3 className="text-sm font-semibold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
            <Wallet size={16} className="text-purple-500" /> Expenses by
            Category
          </h3>
          <div className="space-y-3">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl p-5 border border-gray-200 dark:border-gray-800 shadow-sm">
          <h3 className="text-sm font-semibold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
            <Banknote size={16} className="text-purple-500" /> Payments by
            Method
          </h3>
          <div className="space-y-3">
